...
If the codebase is empty and purpose is unclear, say: *"I don't have a clear picture of what you're building yet. Can you describe the product so I can propose a design system that fits?"*

**Visual research (optional):**

> **Note:** If you have browser automation tools available (Playwright, Puppeteer, etc.), you can use them to capture screenshots of competitor sites during the research phase. This is optional. The skill works well without browser automation, using WebSearch and built-in design knowledge instead.
...
**Step 2: Visual research (if browser automation is available)**

If you have browser automation tools, visit the top 3-5 sites in the space and capture screenshots for visual analysis. For each site, analyze: fonts actually used, color palette, layout approach, spacing density, aesthetic direction.

If a site blocks the headless browser or requires login, skip it and note why.

If browser automation is not available, rely on WebSearch results and your built-in design knowledge. This is fine.
...
- Browser automation available: screenshots + snapshots + WebSearch (richest research)
