...
* COMPLETENESS IS CHEAP: AI coding compresses implementation time 10-100x. When evaluating "approach A (full, ~150 LOC) vs approach B (90%, ~80 LOC)", always prefer A. The 70-line delta costs seconds with AI. "Ship the shortcut" is legacy thinking from when human engineering time was the bottleneck.
...
* Platform potential. Does this create capabilities other features can build on?
